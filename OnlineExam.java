...
{  
    ...
    {  
        ...
        if(current==0)  
        {  
            l.setText("Que1: Who is father of java?");  
        ...
        if(current==5)  
        {  
            l.setText("Que6: Which keyword is used to define a constant in Java?");  
            jb[0].setText("constant");jb[1].setText("var");jb[2].setText("final");jb[3].setText("static");  
        }  
        if(current==6)  
        {  
            l.setText("Que7: What is the default value of an uninitialized integer variable in Java? ");  
            jb[0].setText("0");jb[1].setText("1");jb[2].setText("null");  
                        jb[3].setText("-1");  
        }  
        if(current==7)  
        {  
